...
public class AtcEventAirplaneLanded extends AtcEvent
{
	...
	public AtcEventType getType(
		...
		return AtcEventType.AIRPLANE_LANDED;
	}
	...
	public String toString(
		...
		return "AirplaneLanded [airplaneId=" + airplaneId + "]";
	}
